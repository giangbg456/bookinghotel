                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                    $i=1;
                                    $sql = "SELECT checked.id as id,checked.name as name1 , room_category.name as name2 , ref_no , contact_no ,date_in,date_out, price,status FROM checked,room_category WHERE checked.room_id = room_category.id";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="checkout_booking2.php?id=<?php echo $data['id']?>"><button type="button"
                                                class="btn btn-primary" id="checkout">Checkout</button></a>
                                        <button type="button" class="btn btn-primary" id="edit_checkin"
                                            data-toggle="modal" data-target="#modal_edit"
                                            data-id="<?php echo $data['id'] ?>" data-name="<?php echo $data['name1'] ?>"
                                            data-contact="<?php echo $data['contact_no'] ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="body_edit">
                <div class="container-fluid">
                    ...
                    <form action="edit_checkin2.php" id="manage-check" method="post">
